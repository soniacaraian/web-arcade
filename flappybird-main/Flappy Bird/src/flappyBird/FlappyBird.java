...
//        jframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        bird = new Rectangle(900, HEIGHT /2 + 30, 20, 20);
    ...
    public void jump(){
        if(gameOver){
            bird = new Rectangle(900, HEIGHT /2 - 10 , 20, 20);
            columns.clear();
            yMotion = 0;
            score = 0;
    ...
    public void repaint(Graphics g){
        ...
        if(!started){
            ...
            g.drawString("FLAPPY BIRD", 580, HEIGHT - 600);
        ...
        if(gameOver){
            ...
            g.drawString(failTexts.get(0), 250, HEIGHT -600);
        }
        
        if(!gameOver && started){
            g.setFont(new Font("Arial", 1, 75));
            g.setColor(Color.pink);
            g.drawString(String.valueOf((int)score), 880, 150);
